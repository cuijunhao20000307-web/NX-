...
// Creates a connected TCP socket to target_host:target_port.
// In HTTP/SOCKS5 mode the connection is tunneled through cfg.
// Caller owns the returned socket and must close() it.
